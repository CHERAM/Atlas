...
When a user says `activate`, start Atlas mode selection by reading `.github/atlas_mode.md`.
...
Contract rules:
- Read mode menu and mappings from `.github/atlas_mode.md`.
- After mode selection, show mode strengths and ask for Auto or Manual mode.
...
- Switch mode with: `switch` or `activate <mode name>`
